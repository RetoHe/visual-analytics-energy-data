...
import pandas as pd
# Import Data
oil_data = pd.read_csv("data/raw/oil_consumption_per_cap.csv")
# Transpose Data
...
oil_cons_cleaned["Oil_Cons_Africa_pp"] = oil_consumption_africa
oil_cons_cleaned["Oil_Cons_Europe_pp"] = oil_consumption_europe
