...
import pandas as pd
# Import Data
oil_data = pd.read_csv("data/raw/nuclear_power_generation_total.csv")
# Transpose Data
...
oil_cons_cleaned["Nuclear_Asia"] = oil_consumption_asia
oil_cons_cleaned["Nuclear_Africa"] = oil_consumption_africa
oil_cons_cleaned["Nuclear_Europe"] = oil_consumption_europe
oil_cons_cleaned["Nuclear_NA"] = oil_consumption_north_america
oil_cons_cleaned["Nuclear_SA"] = oil_consumption_south_america
oil_cons_cleaned["Nuclear_Oceania"] = oil_consumption_oceania
oil_cons_cleaned["Nuclear_Total"] = oil_cons_cleaned["Nuclear_Asia"]+oil_cons_cleaned["Nuclear_Africa"]+oil_cons_cleaned["Nuclear_Europe"]+oil_cons_cleaned["Nuclear_NA"]+oil_cons_cleaned["Nuclear_SA"]+oil_cons_cleaned["Nuclear_Oceania"]


# Export new Dataframe
oil_cons_cleaned.to_csv("data/nuclear_prod.csv")